...
ENDPOINT_SELL_STOCKS = "/{stock_id}/sell-stocks/"  # done
ENDPOINT_SELL_FD = "/{fd_id}/sell-fd/"  # done
ENDPOINT_SELL_ASSET = "/{asset_id}/sell-asset/"  # done
...
@data_edit_router.post(ENDPOINT_SELL_STOCKS)
...
@data_edit_router.post(ENDPOINT_SELL_ASSET)
...
@data_edit_router.post(ENDPOINT_SELL_FD)
async def sell_fd(
    request: SellRequest,
    fd_id: UUID,
    verified_user: VerifiedUser = Depends(verify_user),
